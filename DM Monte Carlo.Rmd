...
```{r optimization}
thresholds <- seq(500, 1500, 10)
opt.sim.count <- 50
optimization.data <- data.frame(threshold.values = thresholds, npv = c(0))

hist(coal.data$Percent.SO2.reduction)
#TODO try with different efficiencies based on coal data
#TODO factor in prediction error
